  ...
  return dashData && (
    <div className='p-4 sm:p-8'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8'>
        {/* Earnings Card */}
        <div className='group relative overflow-hidden bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 animate-slideUp'>
          ...
          <div className='relative z-10'>
            ...
            <h3 className='text-white/80 text-sm font-medium mb-1'>Total Earnings</h3>
            <p className='text-4xl font-bold text-white'>{currency}{dashData.earning}</p>
        ...
        {/* Appointments Card */}
        <div className='group relative overflow-hidden bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 animate-slideUp animation-delay-100'>
          <div className='absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500'></div>
          <div className='relative z-10'>
            <div className='flex items-center justify-between mb-4'>
              <div className='w-14 h-14 bg-white/20 rounded-xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-300'>
            ...
            <h3 className='text-white/80 text-sm font-medium mb-1'>Total Appointments</h3>
        ...
        {/* Patients Card */}
        <div className='group relative overflow-hidden bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 animate-slideUp animation-delay-200'>
          <div className='absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500'></div>
          <div className='relative z-10'>
            <div className='flex items-center justify-between mb-4'>
              <div className='w-14 h-14 bg-white/20 rounded-xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-300'>
            ...
            <h3 className='text-white/80 text-sm font-medium mb-1'>Unique Patients</h3>
        ...
        <div className='divide-y divide-gray-100'>
          {dashData.latestAppointments && dashData.latestAppointments.length > 0 ? (
                ...
                {item.cancelled ? (
                  ...
                  <div className='flex gap-2'>
                    <button
                      ...
                      className='p-2 bg-red-100 text-red-600 hover:bg-red-200 rounded-lg transition-all duration-200 transform hover:scale-110'
                      title='Cancel'
                    >
                    ...
                    <button
                      ...
                      className='p-2 bg-green-100 text-green-600 hover:bg-green-200 rounded-lg transition-all duration-200 transform hover:scale-110'
                      title='Complete'
                    >
                      <svg className='w-5 h-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
            ...
            <div className='py-12 text-center'>
              ...
              <p className='text-gray-400 text-sm mt-1'>New patient bookings will appear here</p>
            </div>
          )}
        </div>
      </div>
