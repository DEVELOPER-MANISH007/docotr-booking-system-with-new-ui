      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll ">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            ...
            <div className="flex-1 flex flex-col gap-1">
              <p> Fees </p>
              <input  onChange={(e)=>setFees(e.target.value)} value={fees} className="border rounded px-3 py-3" type="number" placeholder="Your fees" required />
            </div>
          </div>
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4 ">
            ...
            <div className="flex-1 flex flex-col gap-1">
              <p> Education </p>
              <input onChange={(e)=>setEducation(e.target.value)} value={education} className="border rounded px-3 py-3" type="text" placeholder="Your education" required />
            </div>
            <div className="flex-1 flex flex-col gap-1">
              <p> Address </p>
              <input onChange={(e)=>setAddress1(e.target.value)} value={address1} className="border rounded px-3 py-3" type="text" placeholder="Address line 1" required />
              <input onChange={(e)=>setAddress2(e.target.value)} value={address2} className="border rounded px-3 py-3" type="text" placeholder="Address line 2" required />
            </div>
          </div>
        </div>
        ...
        <button type="submit" className="bg-primary px-10 py-3 font-semibold text-sm rounded mt-4 text-white hover:bg-blue-800 cursor-pointer" >Add Doctor</button>
      </div>
    </form>
  );
};
